...
:heavy_check_mark: CovidHealthCheck_1_0_0_3.zip --> Application Power Apps Model Driven avec un formulaire Portal\
:heavy_check_mark: CloudFlowWorkshop_1_0_0_1.zip --> Exemple d'utilsiation des Dataverse List Row dans Power Automate
